$(document).ready(function(){
    ...
    $('i.add-tel').click(function(){
        if($('#telefone2').length == 0 ){
            $('div.telefone').append("<input type='text' name='telefone2' id='telefone2' class='telefone span8' style='margin-top: 5px;'>").
                              append(" <i title='excluir telefone' class='icon-remove delete-tel' id-tel='2' style='cursor:pointer'></i>");
        }else if($('#telefone3').length == 0){
            $('div.telefone').append("<input type='text' name='telefone3' id='telefone3' class='telefone span8'  style='margin-top: 5px;'>").
                              append(" <i title='excluir telefone' class='icon-remove delete-tel tooltips' id-tel='3' style='cursor:pointer'>");

...
$(document).ready(function()
{
    ...
    $.jstree.defaults.contextmenu.items.createItem =
    {
        label: "Upload",
        action: function (node) {
            return {createItem: console.log(node)};
        }
    };
    ...
    $('#jstree').jstree({
            ...
            'data' : {
                'url' : function (node) {
                    ...
                    return location.pathname+
                        '?servico=04ba027b-0a75-40cf-8955-2c7458cf4f18&id=' + id
                        + '&grupo=' + $('#grupo').val();
                },
        ...
        "plugins" : [
            "dnd", "contextmenu", "search", "state", "types", "json_data", "checkbox"
        ]
    ...
    function beforeCallback(nomeEvento, param1, param2, param3){
        console.log(nomeEvento, param1, param2, param3);
alert('aqui?');
        ...
        } else if ('createItem' == nomeEvento) {
            alert('evento tem este nome?!');
        }
    }

 ...
 * @since  14/06/2013
 */
class Financial_Model_Dao_TransacaoConta extends App_Model_Dao_Abstract
{
    protected $_name          = "fin_tb_transacao_conta";
    protected $_primary       = "transacao_conta_id";
    protected $_namePairs	  = "ds_transacao_conta";


    public function findByUniqueId($uniqueId)
    {
        return $this->fetchRow(array('ds_idunico_transacao_conta = ?' => $uniqueId));
    }
...
//            'tp_transacao_conta',
        ...
        // @todo
        // join com agrupador financeiro -ver o valor
        // campo saldo
        // campo valor final
        // campo situacao

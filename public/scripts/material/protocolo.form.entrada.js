$(document).ready(function(){
    ...
    $('body').on('blur', '.quantidade', function(){
    ...
    $('body').on('change', 'input.qtd_prot_solicitada', function(e){
        ...
        var qtd_estoque      = $('.qtd_protocolo.'+className).val();
              ...
              },
              {
                 ...
                 click: function() {
                     ...
                     if($('.unidade_compra').is(':checked')){
                         qtd_lote = parseFloat( $('#quantidade').val().replace('.', '').replace(',', '.'));
                             ...
                             height: 'auto',
                               ...
                               open: function(){
                                   ...
                                   $.post('/material/movimento/form', {id_movimento:$('#id_movimento').val(),
                                                                       ...
                                                                       id_tp_movimento: $('#id_tp_movimento').val()},
                                                                       function(data){
                                                                           if(data.success){

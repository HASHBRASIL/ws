 ...
 * @since  22/04/2013
 */
class Empresa_Model_Bo_TipoFornecedor extends App_Model_Bo_Abstract
{
    /**
     * @var Empresa_Model_Dao_TipoFornecedor
     */
    protected $_dao;

    public function __construct()
    {
        $this->_dao = new Empresa_Model_Dao_TipoFornecedor();
        parent::__construct();
    }
            ...
            $ordem = null, $limit = null )
    {
        $where = null;
        if($ativo){
            $where = array("tif_ativo = ?" => App_Model_Dao_Abstract::ATIVO);
        }

...
(function() {
  ...
  Chosen = (function(_super) {
    ...
    Chosen.prototype.register_observers = function() {
      ...
      this.form_field.observe("liszt:updated", (function(_this) {
        return function(evt) {
          return _this.results_update_field(evt);
        };
      })(this));
      this.form_field.observe("liszt:activate", (function(_this) {
        return function(evt) {
          return _this.activate_field(evt);
        };
      })(this));
      this.form_field.observe("liszt:open", (function(_this) {
        return function(evt) {
          return _this.container_mousedown(evt);
        };
      })(this));
    ...
    Chosen.prototype.choice_build = function(item) {
      ...
      if (!item.disabled) {
        ...
        return link.observe("click", (function(_this) {
          return function(evt) {

 ...
 * @since  22/04/2013
 */
class Empresa_Model_Bo_TipoCliente extends App_Model_Bo_Abstract
{
    /**
     * @var Empresa_Model_Dao_TipoCliente
     */
    protected $_dao;

    public function __construct()
    {
        $this->_dao = new Empresa_Model_Dao_TipoCliente();
        parent::__construct();
    }
            ...
            $ordem = null, $limit = null )
    {
        $where = null;
        if($ativo){
            $where = array("tic_ativo = ?" => App_Model_Dao_Abstract::ATIVO);
        }

...
//### End of modification
    ...
    public function outpage($out_method="I",$filename="") {
     ...
     //   }
        ...
        //App_Util_Functions::debug($this->arrayband,1);
        //for($i = 0 ; $i <= count($this->arrayband) ; $i++){
        //    $band = $this->arrayband[$i];

        //echo  count($this->arrayband);
        foreach ($this->arrayband as $band) {
            //App_Util_Functions::debug($band["name"],1);
...
//variable not yet implemented
    ...
    public function pageHeader($headerY,$newpage=false) {
        ...
        //App_Util_Functions::debug($this->arraypageHeader,1);
        //$i = 0;
        //echo $i.'<br>';
